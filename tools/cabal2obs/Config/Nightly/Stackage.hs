...
stackage =
  ...
  , "genvalidity ==0.5.0.3"
  , "genvalidity-aeson ==0.2.0.1"
  , "genvalidity-bytestring ==0.2.0.1"
  , "genvalidity-containers ==0.4.0.1"
  , "genvalidity-hspec ==0.6.0.3"
  , "genvalidity-hspec-aeson ==0.2.0.1"
  , "genvalidity-hspec-binary ==0.2.0.1"
  , "genvalidity-hspec-cereal ==0.2.0.1"
  , "genvalidity-hspec-hashable ==0.2.0.1"
  , "genvalidity-path ==0.3.0.1"
  , "genvalidity-property ==0.2.0.2"
  , "genvalidity-scientific ==0.2.0.1"
  , "genvalidity-text ==0.5.0.1"
  , "genvalidity-time ==0.2.0.2"
  , "genvalidity-unordered-containers ==0.2.0.3"
  , "genvalidity-vector ==0.2.0.1"
  , "geodetics ==0.0.5"
  ...
  , "validation ==1"
  , "validity ==0.6.0.0"
  , "validity-aeson ==0.2.0.1"
  , "validity-bytestring ==0.3.0.1"
  , "validity-containers ==0.3.0.1"
