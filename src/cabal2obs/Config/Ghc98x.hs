...
constraintList = [ "adjunctions ^>= 4.4.2"
                 ...
                 , "c2hs"
                 , "cabal-doctest ^>= 1.0.9"
                 , "cabal-install < 3.10.3"           -- ghc-9.8.3 will support that version
                 , "cabal-install-solver < 3.10.3"    -- ghc-9.8.3 will support that version
                 , "cabal-plan"
                 , "cabal2spec ^>= 2.7.0"
                 , "cairo >=0.13"
                 , "call-stack ^>= 0.4.0"
                 ...
                 , "hadolint"
                 , "half ^>= 0.3.1"
                 , "happy == 1.20.1.1"          -- newer versions are hard to update to (see t/happy-2.x branch)
                 , "hashable ^>= 1.4.3.0"
                 , "hashtables ^>= 1.3.1"
                 , "haskell-lexer ^>= 1.1.1"
                 , "hinotify ^>= 0.4.1"
                 ...
                 , "polyparse ^>= 1.13"
                 , "postgresql-libpq ^>= 0.10.0.0 && < 0.10.2.0"
