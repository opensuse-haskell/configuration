...
constraintList = [ "adjunctions ^>= 4.4.2"
                 ...
                 , "http-conduit < 2.3.8.3"             -- newer versions pull in attoparsec-aeson
                 , "http-date ^>= 0.0.11"
                 , "http-media ^>= 0.8.0.0"
                 , "http-types ^>= 0.12.3"
                 , "http2 ^>= 3.0.3"
                 ...
                 , "wai-extra ^>= 3.1.13.0"
                 , "wai-logger ^>= 2.4.0"
                 , "warp < 3.3.26"      -- newer versions depend on crypton
                 , "warp-tls < 3.3.7"   -- newer versions depend on crypton
                 , "witherable ^>= 0.4.2"
                 , "wizards ^>= 1.0.3"
                 , "word-wrap ^>= 0.5"
                 , "word8 ^>= 0.1.3"
