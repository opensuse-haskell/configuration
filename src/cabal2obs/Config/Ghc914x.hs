...
module Config.Ghc914x ( ghc914x ) where
...
ghc914x :: Action PackageSetConfig
ghc914x = do
  let compiler = "ghc-9.14.1"
...
constraintList = [ "adjunctions ^>= 4.4.3"
                 ...
                 , "ghc-lib-parser"     -- TODO: ^>= 9.14 crashes
                 , "ghc-lib-parser-ex"
                 , "git-annex"
                 , "githash ^>= 0.1.7.0"
                 , "Glob ^>= 0.10.2"
...
ghcCorePackages = [ "array-0.5.8.0"
                  ...
                  , "file-io-0.1.5"
                  , "filepath-1.5.4.0"
                  , "ghc-boot-9.14.0.20251128"
                  , "ghc-boot-th-9.14.0.20251128"
                  , "ghc-compact-0.1.0.0"
                  , "ghc-experimental-9.1400.0"
                  , "ghc-heap-9.14.0.20251128"
                  , "ghc-internal-9.1400.0"
                  , "ghc-platform-0.1.0.0"
                  , "ghc-prim-0.13.1"
                  , "ghc-toolchain-0.1.0.0"
                  , "ghci-9.14.0.20251128"
                  , "haddock-api-2.33.0"
